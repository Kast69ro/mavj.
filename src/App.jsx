...
const HOW_STEPS = [
  ...
  },
  {
    ...
    icon: "❓",
    title: "Отвечайте",
    desc: "До 15 вопросов в день. +10 за 90 дирам в доп. пакете.",
  },
  {
    n: "Шаг 03",
    icon: "⭐",
    title: "Копите баллы",
    desc: "5–10 баллов за ответ. Максимум 175 в день.",
  },
  {
    n: "Шаг 04",
    icon: "🏆",
...
const RULES = [
  ...
  {
    icon: "⏱️",
    title: "15 минут на ответ",
    desc: "Таймер запускается при получении вопроса. Первый ответ принимается.",
  },
  {
    icon: "🔄",
    title: "Сброс 1-го числа",
    desc: "Баллы обнуляются каждый месяц. Победители участвуют снова.",
  },
  {
    icon: "⚡",
    title: "Джекпот",
    desc: "Если порог не набран — приз переходит и суммируется в следующем месяце.",
  },
  {
    icon: "🛡️",
    title: "Антифрод",
